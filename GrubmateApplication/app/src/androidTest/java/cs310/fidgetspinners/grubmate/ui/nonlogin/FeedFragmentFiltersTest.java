...
/*
 * This is to test that we stay on the FeedFragment when we click on any of the filters belonging to the FeedFragment.
 */
@LargeTest
@RunWith(AndroidJUnit4.class)
public class FeedFragmentFiltersTest {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void feedFragmentFiltersTest() {

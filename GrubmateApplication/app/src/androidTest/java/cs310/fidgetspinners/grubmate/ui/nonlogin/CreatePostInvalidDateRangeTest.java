...
public class CreatePostInvalidDateRangeTest {
    ...
    public void createPostInvalidDateRangeTest() {
        ...
        appCompatImageButton.perform(PickerActions.setDate(2020, 12, 31));
        ...
        // default date selected is current date so just press ok and it will be chosen
